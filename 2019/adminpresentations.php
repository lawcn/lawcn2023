...
<html lang="en-us">
	...
	<!-- header-------------------------------------------------------------------------------------------------------------- -->
		<div id="fullpage" name="fullpage">
            ...
            <div id='login' class="d-flex justify-content-center align-items-center" style="position:relative; flex:1;width:100%; height:300px; justify_content:'center'; align_items:'center'">
					<form action="presentationmanager.php" method="POST"  enctype="multipart/form-data">
						...
						<button type="submit" class="btn btn-primary btn-info buttons">Submit</button>
					  </form>
			</div>
	<!-- content----------------------------------------------------------------------------------------------------- -->
